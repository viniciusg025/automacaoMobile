...
const css_converter_1 = __importDefault(require("../../lib/css-converter"));
    ...
    describe('simple cases', function () {
        ...
        for (const [cssSelector, uiAutomatorSelector] of simpleCases) {
            it(`should convert '${cssSelector}' to '${uiAutomatorSelector}'`, function () {
                (0, chai_1.expect)(new css_converter_1.default(cssSelector).toUiAutomatorSelector()).to.equal(uiAutomatorSelector);
            });
        }
    });
    describe('unsupported css', function () {
        ...
        for (const cssSelector of testCases) {
            it(`should reject '${cssSelector}'`, function () {
                (0, chai_1.expect)(() => new css_converter_1.default(cssSelector).toUiAutomatorSelector()).to.throw();
            });
        }
    });
});
