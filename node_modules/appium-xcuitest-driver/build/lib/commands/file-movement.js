...
async function pushFileToRealDevice(remotePath, base64Data) {
    ...
    try {
        await (0, real_device_management_1.pushFile)(service, Buffer.from(base64Data, 'base64'), relativePath);
    }
    catch (e) {
...
async function pullFromRealDevice(remotePath, isFile) {
    ...
    try {
        ...
        return fileInfo.isFile()
            ? (await (0, real_device_management_1.pullFile)(service, relativePath)).toString('base64')
            : (await (0, real_device_management_1.pullFolder)(service, relativePath)).toString();
    }
    finally {
        service.close();
    }
