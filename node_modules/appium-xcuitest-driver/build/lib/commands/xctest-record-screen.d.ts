 ...
 * @this {XCUITestDriver}
 */
export function mobileStartXctestScreenRecording(this: import("../driver").XCUITestDriver, fps?: number, codec?: number): Promise<XcTestScreenRecordingInfo>;
/**
 ...
 */
export function mobileGetXctestScreenRecordingInfo(): Promise<XcTestScreenRecordingInfo | null>;
/**
 ...
 * @this {XCUITestDriver}
 */
export function mobileStopXctestScreenRecording(this: import("../driver").XCUITestDriver, remotePath?: string, user?: string, pass?: string, headers?: import("@appium/types").HTTPHeaders, fileFieldName?: string, formFields?: Record<string, any> | [string, any][], method?: "PUT" | "POST" | "PATCH"): Promise<XcTestScreenRecording>;
