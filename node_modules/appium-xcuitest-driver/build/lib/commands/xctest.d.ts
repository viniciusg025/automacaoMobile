 ...
 * @this {XCUITestDriver}
 */
export function mobileRunXCTest(this: import("../driver").XCUITestDriver, testRunnerBundleId: string, appUnderTestBundleId: string, xcTestBundleId: string, args?: string[], testType?: "app" | "ui" | "logic", env?: import("@appium/types").StringRecord, timeout?: number): Promise<import("./types").RunXCTestResult>;
/**
 ...
 * @this {XCUITestDriver}
 */
export function mobileInstallXCTestBundle(this: import("../driver").XCUITestDriver, xctestApp: string): Promise<void>;
/**
 ...
 * @this {XCUITestDriver}
 */
export function mobileListXCTestBundles(this: import("../driver").XCUITestDriver): Promise<string[]>;
/**
 ...
 * @this {XCUITestDriver}
 */
export function mobileListXCTestsInTestBundle(this: import("../driver").XCUITestDriver, bundle: string): Promise<string[]>;
